...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CreateAcccountButton=(Button) findViewById(R.id.register_btn);
    ...
    private void ValidatephoneNumber(final String name, final String phone, final String password) {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot)
            {
                ...
                {
                    HashMap<String, Object> underdataMap = new HashMap<>();
                    underdataMap.put("phone",phone);
                    underdataMap.put("password",password);
                    underdataMap.put("name",name);
                    RootRef.child("Users").child(phone).updateChildren(underdataMap)
